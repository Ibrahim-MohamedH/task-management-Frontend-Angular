...
export class ActivityLogCard {
  ...
  private readonly STATUS_VALUES  = new Set(['pending','in_progress','completed','cancelled','active','archived','suspended','on_hold']);
  ...
  getStatusBadgeClass(value: string | null): string {
    if (!value) return `${this.VALUE_BASE} bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400`;
